...
async def update_triggers():
    async with engine.begin() as conn:
        print("Updating notify_mentorship_request() function and trigger...")
        await conn.execute(text("""
            ...
            BEGIN
              ...
              IF NEW.status = 'PENDING_GUARDIAN' THEN
                -- Notify Guardian
        ...
        print("Updating notify_mentorship_approval() function and trigger...")
        await conn.execute(text("""
            ...
            BEGIN
              ...
              IF NEW.status = 'APPROVED' AND OLD.status = 'PENDING' THEN
                ...
                VALUES (
                  ...
                  COALESCE(mentor_name, 'Your mentor') || ' has approved your mentorship request. Start chatting now!',
                  false,
                  '/chat'
                );
              END IF;
